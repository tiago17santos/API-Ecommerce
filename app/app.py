...
app = Flask(__name__)
#chave para autenticar no LoginManager
...
#para testar com swagger

#receber a aplicação
login_manager.init_app(app)

#a rota para autenticar (rota login )
...
#Rotas para conexão com banco de dados
